...
namespace Common
{
    ...
    /// </summary>
    internal interface IAsyncStorage : IDisposable
    {
        /// <summary>
    ...
    /// <summary>
    /// A store of elements that are read and written by blocks, asynchronously
    /// </summary>
    internal interface IAsyncStorage<Element> : IAsyncStorage
    {
        /// <summary>
