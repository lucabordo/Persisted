...
namespace Common.Test
{
    ...
    public class UnitTests
    {
        ...
        public void TestByteBufferBasics()
        {
            ...
            var read = buffer.GetWriteCursor(1, 3);
            read[0] = (byte)'A';
            read[1] = (byte)'B';

            buffer.Resize(20, ignoreContent: false);
            var write = buffer.GetReadCursor(1, 3);
        ...
        public void TestByteBufferBatchFull()
        {
            ...
            var write = buffer.GetBlockWriter(20);
            Assert.AreEqual(10, write.Count);
            write.Write(0, truth, 0, 10);

            var read = buffer.GetReadCursor(10, 20);
        ...
        {
            var buffer = new ByteBuffer(100);
            var read = buffer.GetReadCursor(5, 20);
            byte b = read[-1];
        }
